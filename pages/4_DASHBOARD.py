...
st.markdown("""<h4 style="color: #93C56D">  aqui voce acompanha graficos e estatisticas uteis para mapear a prova do iff rumo sua aprovação </h4>""", unsafe_allow_html=True)
